...
const Home = () => {
    ...
    const columnDescriptions = {
        ...
        'consumer_avg_review_score': { type: 'float', description: 'The average review score given by consumer.', example: '4.2' },
  ...
  "Records": [
    {
      ...
      "consumer_avg_review_score": "your_avg_review_score",
