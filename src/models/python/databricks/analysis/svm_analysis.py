...
disp_cm_val = show_confusion_matrix(y_val, y_pred_val, svm)
disp_cm_test = show_confusion_matrix(y_test, y_pred_test, svm)
...
lc_plt = plot_learning_curve(svm, X_train_scaled, y_train)
lc_plt.show()
